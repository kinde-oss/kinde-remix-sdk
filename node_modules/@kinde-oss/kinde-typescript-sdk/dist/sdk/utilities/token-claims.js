 ...
 */
export var getClaimValue = function (sessionManager, claim, type) {
 ...
 */
export var getClaim = function (sessionManager, claim, type) {
    if (type === void 0) { type = 'access_token'; }
    return __awaiter(void 0, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getClaimValue(sessionManager, claim, type)];
 ...
 */
export var getPermission = function (sessionManager, name) { return __awaiter(void 0, void 0, void 0, function () {
    var permissions, isGranted, orgCode;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, getClaimValue(sessionManager, 'permissions')];
            case 1:
                permissions = ((_a = (_b.sent())) !== null && _a !== void 0 ? _a : []);
                isGranted = permissions.some(function (p) { return p === name; });
                return [4 /*yield*/, getClaimValue(sessionManager, 'org_code')];
            case 2:
                orgCode = (_b.sent());
 ...
 */
export var getOrganization = function (sessionManager) { return __awaiter(void 0, void 0, void 0, function () {
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
 ...
 */
export var getPermissions = function (sessionManager) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, permissions, orgCode;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, Promise.all([
                    ((_b = getClaimValue(sessionManager, 'permissions')) !== null && _b !== void 0 ? _b : []),
 ...
 */
export var getUserOrganizations = function (sessionManager) { return __awaiter(void 0, void 0, void 0, function () {
    var _a;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = {};
                return [4 /*yield*/, getClaimValue(sessionManager, 'org_codes', 'id_token')];
