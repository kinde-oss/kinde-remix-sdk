...
var createAuthorizationCodeClient = function (options, isPKCE) {
    ...
    return __assign(__assign({}, withAuthUtilities(isAuthenticated)), { handleRedirectToApp: handleRedirectToApp, isAuthenticated: isAuthenticated, getUserProfile: getUserProfile, createOrg: createOrg, getToken: getToken, register: register, getUser: getUser, logout: logout, login: login });
};
