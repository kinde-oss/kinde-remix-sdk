...
export var fetchClient = jest.fn().mockImplementation(function () { return __awaiter(void 0, void 0, void 0, function () {
...
export var getMockAccessToken = function (domain, isExpired, isExpClaimMissing) {
...
export var getMockIdToken = function (domain, isExpired) {
    if (domain === void 0) { domain = 'local-testing@kinde.com'; }
    if (isExpired === void 0) { isExpired = false; }
    var iat = Math.floor(Date.now() / 1000);
...
export var sessionManager = new ServerSessionManager();
