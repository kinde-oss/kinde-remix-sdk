...
import { commitTokensToMemory, commitTokenToMemory, isTokenExpired, } from '../../../sdk/utilities';
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, commitTokensToMemory(sessionManager, tokenCollection)];
                    case 1:
                        _d.sent();
                        _a = expect;
        ...
        it('stores provided token to memory', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        mockAccessToken = mocks.getMockAccessToken(domain).token;
                        return [4 /*yield*/, commitTokenToMemory(sessionManager, mockAccessToken, 'access_token')];
                    case 1:
                        _b.sent();
                        _a = expect;
                        return [4 /*yield*/, sessionManager.getSessionItem('access_token')];
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        commitTokenFn = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, commitTokenToMemory(sessionManager, mockAccessToken, 'access_token')];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, commitTokenToMemory(sessionManager, mockIdToken, 'id_token')];
                    case 1:
                        _c.sent();
