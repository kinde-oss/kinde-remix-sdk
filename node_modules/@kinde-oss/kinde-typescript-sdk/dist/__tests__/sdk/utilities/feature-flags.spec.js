...
import { FlagDataType, getFlag } from '../../../sdk/utilities';
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, getFlag(sessionManager, code)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, getFlag(sessionManager, code, true, 's')];
                                    case 1: return [2 /*return*/, _a.sent()];
                                }
                            }); }); }).rejects.toThrowError(new Error("Flag ".concat(code, " is of type ").concat(FlagDataType[flag.t], ", expected type is ").concat(FlagDataType.s)))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('should not throw error for falsy default value which is not `undefined`', function () {
            ...
            var getFlagFnArray = [
                function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, getFlag(sessionManager, code, false, 'b')];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                }); }); },
                function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, getFlag(sessionManager, code, '', 's')];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                }); }); },
                function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, getFlag(sessionManager, code, 0, 'i')];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                }); }); },
            ];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        code = 'non-existant-code';
                        _a = expect;
                        return [4 /*yield*/, getFlag(sessionManager, code, defaultValue)];
                    case 1:
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        flag = featureFlags[code];
                        _d = expect;
                        return [4 /*yield*/, getFlag(sessionManager, code)];
                    case 2:
