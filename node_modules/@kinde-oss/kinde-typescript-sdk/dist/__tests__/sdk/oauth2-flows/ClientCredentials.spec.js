...
describe('ClientCredentials', function () {
    ...
    describe('new ClientCredentials()', function () {
        it('can construct ClientCredentials instance', function () {
            expect(function () { return new ClientCredentials(clientConfig); }).not.toThrowError();
        });
    });
    describe('getToken()', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        client = new ClientCredentials(clientConfig);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockAccessToken = mocks.getMockAccessToken(authDomain).token;
        ...
        it('fetches an access token if no access token is available in memory', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockAccessToken = mocks.getMockAccessToken(clientConfig.authDomain).token;
                        mocks.fetchClient.mockResolvedValue({
        ...
        it('fetches an access token if available access token is expired', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        expiredMockAccessToken = mocks.getMockAccessToken(clientConfig.authDomain, true).token;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        client = new ClientCredentials(__assign(__assign({}, clientConfig), { audience: expectedAudience, scope: expectedScope }));
