...
var oauth2_flows_1 = require("../../../sdk/oauth2-flows");
...
describe('AuthorizationCode', function () {
    ...
    var clientSecret = (0, utilities_1.generateRandomString)(50);
    var clientConfig = {
    ...
    describe('new AuthorizationCode', function () {
        it('can construct AuthorizationCode instance', function () {
            expect(function () { return new oauth2_flows_1.AuthorizationCode(clientConfig, 'client-secret'); }).not.toThrowError();
        });
    });
    describe('createAuthorizationURL()', function () {
        ...
        it('uses default scopes if none is provided in the url options', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        client = new oauth2_flows_1.AuthorizationCode(clientConfig, clientSecret);
                        return [4 /*yield*/, client.createAuthorizationURL(sessionManager)];
                    case 1:
                        authURL = _a.sent();
                        searchParams = new URLSearchParams(authURL.search);
                        expect(searchParams.get('scope')).toBe(oauth2_flows_1.AuthorizationCode.DEFAULT_TOKEN_SCOPES);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        testClient = new oauth2_flows_1.AuthorizationCode(__assign(__assign({}, clientConfig), { audience: expectedAudience, scope: expectedScope }), 'client-secret');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        stateKey = oauth2_flows_1.AuthorizationCode.STATE_KEY;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, sessionManager.setSessionItem(oauth2_flows_1.AuthorizationCode.STATE_KEY, 'state')];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        headers = new Headers();
                        headers.append.apply(headers, __spreadArray([], __read((0, version_1.getSDKHeader)(headerOverrides)), false));
                        headers.append('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
                        client = new oauth2_flows_1.AuthorizationCode(__assign(__assign({}, clientConfig), headerOverrides), clientSecret);
                        return [4 /*yield*/, client.getToken(sessionManager)];
                    case 3:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, expect(getTokenFn).rejects.toBeInstanceOf(exceptions_1.KindeSDKError)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, expect(getTokenFn).rejects.toHaveProperty('errorCode', exceptions_1.KindeSDKErrorCode.FAILED_TOKENS_REFRESH_ATTEMPT)];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
