...
describe('AuthCodeWitPKCE', function () {
    ...
    describe('new AuthCodeWithPKCE', function () {
        it('can construct AuthCodeWithPKCE instance', function () {
            expect(function () { return new oauth2_flows_1.AuthCodeWithPKCE(clientConfig); }).not.toThrowError();
        });
    });
    describe('createAuthorizationURL()', function () {
        ...
        it('saves generated code verifier to session storage again state', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        client = new oauth2_flows_1.AuthCodeWithPKCE(clientConfig);
                    ...
                    case 1:
                        ...
                        codeVerifierKey = "".concat(oauth2_flows_1.AuthCodeWithPKCE.STATE_KEY, "-").concat(state);
                        _b = (_a = JSON).parse;
                    ...
                    case 2:
                        ...
                        _c = utilities_1.base64UrlEncode;
                        return [4 /*yield*/, (0, utilities_1.sha256)(codeVerifier)];
                    case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        codeVerifierKey = "".concat(oauth2_flows_1.AuthCodeWithPKCE.STATE_KEY, "-state");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        headers.append('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
                        client = new oauth2_flows_1.AuthCodeWithPKCE(__assign(__assign({}, clientConfig), headerOverrides));
                        return [4 /*yield*/, client.getToken(sessionManager)];
                    case 3:
                        _a.sent();
