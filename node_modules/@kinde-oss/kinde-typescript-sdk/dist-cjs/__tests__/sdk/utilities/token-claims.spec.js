    ...
    describe('getClaimValue', function () {
        it('returns value for a token claim if claim exists', function () {
            Object.keys(mockAccessToken.payload).forEach(function (name) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, utilities_1.getClaimValue)(sessionManager, name)];
                        case 1:
                            claimValue = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, utilities_1.getClaimValue)(sessionManager, claimName)];
                    case 1:
                        claimValue = _a.sent();
    ...
    describe('getClaim', function () {
        it('returns value for a token claim if claim exists', function () {
            Object.keys(mockAccessToken.payload).forEach(function (name) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, utilities_1.getClaim)(sessionManager, name)];
                        case 1:
                            claim = _a.sent();
                            tokenPayload = mockAccessToken.payload;
        ...
        it('return null if claim does not exist', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        claimName = 'non-existant-claim';
                        return [4 /*yield*/, (0, utilities_1.getClaim)(sessionManager, claimName)];
                    case 1:
                        claim = _a.sent();
            ...
            permissions.forEach(function (permission) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = expect;
                            return [4 /*yield*/, (0, utilities_1.getPermission)(sessionManager, permission)];
                        case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = expect;
                        return [4 /*yield*/, (0, utilities_1.getPermission)(sessionManager, permissionName)];
                    case 1:
                        _a.apply(void 0, [_b.sent()]).toStrictEqual({
                            orgCode: orgCode,
                            isGranted: false,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = expect;
                        return [4 /*yield*/, (0, utilities_1.getUserOrganizations)(sessionManager)];
                    case 1:
                        _a.apply(void 0, [_b.sent()]).toStrictEqual({
                            orgCodes: orgCodes,
                        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        orgCode = mockAccessToken.payload.org_code;
                        _a = expect;
                        return [4 /*yield*/, (0, utilities_1.getOrganization)(sessionManager)];
                    case 1:
