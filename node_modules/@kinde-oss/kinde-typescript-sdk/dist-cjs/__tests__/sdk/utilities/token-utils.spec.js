...
var exceptions_1 = require("../../../sdk/exceptions");
describe('token-utils', function () {
    ...
    describe('commitTokensToMemory', function () {
        it('stores all provided tokens to memory', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        mockAccessToken = mocks.getMockAccessToken(domain).token;
                        mockIdToken = mocks.getMockAccessToken(domain).token;
                        tokenCollection = {
                            refresh_token: 'refresh_token',
                            access_token: mockAccessToken,
                            id_token: mockIdToken,
                        };
                        return [4 /*yield*/, (0, utilities_1.commitTokensToMemory)(sessionManager, tokenCollection)];
                    case 1:
                        _d.sent();
                        _a = expect;
    ...
    describe('commitTokenToMemory()', function () {
        ...
        it('stores provided token to memory', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        mockAccessToken = mocks.getMockAccessToken(domain).token;
                        return [4 /*yield*/, (0, utilities_1.commitTokenToMemory)(sessionManager, mockAccessToken, 'access_token')];
                    case 1:
                        _b.sent();
                        _a = expect;
                        return [4 /*yield*/, sessionManager.getSessionItem('access_token')];
        ...
        it('throws exception if attempting to store invalid token', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockAccessToken = mocks.getMockAccessToken(domain, true).token;
                        commitTokenFn = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, (0, utilities_1.commitTokenToMemory)(sessionManager, mockAccessToken, 'access_token')];
                                case 1: return [2 /*return*/, _a.sent()];
                            }
                        }); }); };
                        return [4 /*yield*/, expect(commitTokenFn).rejects.toBeInstanceOf(exceptions_1.KindeSDKError)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, expect(commitTokenFn).rejects.toHaveProperty('errorCode', exceptions_1.KindeSDKErrorCode.INVALID_TOKEN_MEMORY_COMMIT)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('stores user information if provide token is an id token', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = mocks.getMockIdToken(domain), mockIdToken = _a.token, idTokenPayload = _a.payload;
                        return [4 /*yield*/, (0, utilities_1.commitTokenToMemory)(sessionManager, mockIdToken, 'id_token')];
                    case 1:
                        _c.sent();
    ...
    describe('isTokenExpired()', function () {
        it('returns true if null is provided as argument', function () {
            expect((0, utilities_1.isTokenExpired)(null)).toBe(true);
        });
        it('returns true if provided token is expired', function () {
            var mockAccessToken = mocks.getMockAccessToken(domain, true).token;
            expect((0, utilities_1.isTokenExpired)(mockAccessToken)).toBe(true);
        });
        it('returns true if provided token is missing "exp" claim', function () {
            var mockAccessToken = mocks.getMockAccessToken(domain, true).token;
            expect((0, utilities_1.isTokenExpired)(mockAccessToken)).toBe(true);
        });
        it('returns false if provided token is not expired', function () {
            var mockAccessToken = mocks.getMockAccessToken(domain).token;
