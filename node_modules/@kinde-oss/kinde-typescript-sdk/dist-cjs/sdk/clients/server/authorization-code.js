...
var createAuthorizationCodeClient = function (options, isPKCE) {
    ...
    return __assign(__assign({}, (0, with_auth_utilities_js_1.default)(isAuthenticated)), { handleRedirectToApp: handleRedirectToApp, isAuthenticated: isAuthenticated, getUserProfile: getUserProfile, createOrg: createOrg, getToken: getToken, register: register, getUser: getUser, logout: logout, login: login });
};
