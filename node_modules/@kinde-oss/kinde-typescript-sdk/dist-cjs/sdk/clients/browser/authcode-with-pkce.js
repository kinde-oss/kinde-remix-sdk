...
var index_js_1 = require("../../session-managers/index.js");
var index_js_2 = require("../../oauth2-flows/index.js");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, utilities.getUserFromMemory(sessionManager)];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, featureFlags.getIntegerFlag(sessionManager, code, defaultValue)];
                case 2: return [2 /*return*/, _a.sent()];
            }
        });
    }); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, featureFlags.getStringFlag(sessionManager, code, defaultValue)];
                case 2: return [2 /*return*/, _a.sent()];
            }
        });
    }); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, featureFlags.getBooleanFlag(sessionManager, code, defaultValue)];
                case 2: return [2 /*return*/, _a.sent()];
            }
        });
    }); };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, tokenClaims.getClaimValue(sessionManager, claim, type)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, tokenClaims.getClaim(sessionManager, claim, type)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, tokenClaims.getPermission(sessionManager, name)];
                case 2: return [2 /*return*/, _a.sent()];
            }
        });
    }); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, tokenClaims.getOrganization(sessionManager)];
                case 2: return [2 /*return*/, _a.sent()];
            }
        });
    }); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, tokenClaims.getUserOrganizations(sessionManager)];
                case 2: return [2 /*return*/, _a.sent()];
            }
        });
    }); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, tokenClaims.getPermissions(sessionManager)];
                case 2: return [2 /*return*/, _a.sent()];
            }
        });
    }); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, featureFlags.getFlag(sessionManager, code, defaultValue, type)];
                case 2: return [2 /*return*/, _a.sent()];
            }
        });
    }); };
