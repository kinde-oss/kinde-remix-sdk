...
var token_claims_js_1 = require("./token-claims.js");
...
var getFlag = function (sessionManager, code, defaultValue, type) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0: return [4 /*yield*/, (0, token_claims_js_1.getClaimValue)(sessionManager, 'feature_flags')];
            case 1:
...
var getIntegerFlag = function (sessionManager, code, defaultValue) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.getFlag)(sessionManager, code, defaultValue, 'i')];
...
var getStringFlag = function (sessionManager, code, defaultValue) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.getFlag)(sessionManager, code, defaultValue, 's')];
            case 1: return [2 /*return*/, (_a.sent()).value];
        }
    });
}); };
...
var getBooleanFlag = function (sessionManager, code, defaultValue) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.getFlag)(sessionManager, code, defaultValue, 'b')];
            case 1: return [2 /*return*/, (_a.sent()).value];
        }
    });
}); };
