    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    token = (_b.sent());
                    tokenPayload = (0, jwt_decode_1.jwtDecode)(token);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, exports.getClaimValue)(sessionManager, claim, type)];
...
var getPermission = function (sessionManager, name) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, exports.getClaimValue)(sessionManager, 'permissions')];
            case 1:
                permissions = ((_a = (_b.sent())) !== null && _a !== void 0 ? _a : []);
                isGranted = permissions.some(function (p) { return p === name; });
                return [4 /*yield*/, (0, exports.getClaimValue)(sessionManager, 'org_code')];
            case 2:
                orgCode = (_b.sent());
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, Promise.all([
                    ((_b = (0, exports.getClaimValue)(sessionManager, 'permissions')) !== null && _b !== void 0 ? _b : []),
...
var getUserOrganizations = function (sessionManager) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = {};
                return [4 /*yield*/, (0, exports.getClaimValue)(sessionManager, 'org_codes', 'id_token')];
