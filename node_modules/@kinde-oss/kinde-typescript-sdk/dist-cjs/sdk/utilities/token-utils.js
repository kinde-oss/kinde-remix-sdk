 ...
 * @returns {void}
 */
var commitUserToMemoryFromToken = function (sessionManager, idToken) { return __awaiter(void 0, void 0, void 0, function () {
    var idTokenPayload, user;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                idTokenPayload = (0, jwt_decode_1.jwtDecode)(idToken);
                user = {
                    family_name: idTokenPayload.family_name,
                    given_name: idTokenPayload.given_name,
                    picture: (_a = idTokenPayload.picture) !== null && _a !== void 0 ? _a : null,
                    email: idTokenPayload.email,
                    id: idTokenPayload.sub,
                };
                return [4 /*yield*/, sessionManager.setSessionItem('user', user)];
            case 1:
                _b.sent();
                return [2 /*return*/];
        }
 ...
 */
var commitTokenToMemory = function (sessionManager, token, type) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/];
            case 2:
                if (type !== 'refresh_token' && (0, exports.isTokenExpired)(token)) {
                ...
                return [4 /*yield*/, sessionManager.setSessionItem(type, token)];
            case 3:
                _a.sent();
                if (!(type === 'id_token')) return [3 /*break*/, 5];
                return [4 /*yield*/, commitUserToMemoryFromToken(sessionManager, token)];
            case 4:
                _a.sent();
                _a.label = 5;
 ...
 * @param tokens
 */
var commitTokensToMemory = function (sessionManager, tokens) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
 ...
 * @returns {string | null}
 */
var getUserFromMemory = function (sessionManager) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sessionManager.getSessionItem('user')];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
 ...
 * @param {UserType} user
 */
var commitUserToMemory = function (sessionManager, user) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, sessionManager.setSessionItem('user', user)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
var isTokenExpired = function (token) {
    ...
    var tokenPayload = (0, jwt_decode_1.jwtDecode)(token);
    if (!tokenPayload.exp)
        return true;
