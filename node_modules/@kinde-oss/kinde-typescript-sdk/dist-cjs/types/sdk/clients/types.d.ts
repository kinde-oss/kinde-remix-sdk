...
import type { ClientCredentialsOptions, AuthorizationCodeOptions, AuthURLOptions } from '../oauth2-flows/index.js';
...
export type RegisterURLOptions = Omit<AuthURLOptions, 'start_page' | 'is_create_org'>;
