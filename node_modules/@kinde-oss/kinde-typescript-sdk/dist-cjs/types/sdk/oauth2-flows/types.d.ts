...
export interface AuthorizationCodeOptions extends OAuth2FlowOptions, SDKHeaderOverrideOptions {
    redirectURL: string;
}
export interface ClientCredentialsOptions extends OAuth2FlowOptions, SDKHeaderOverrideOptions {
    clientSecret: string;
}
